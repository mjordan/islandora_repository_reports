...
This module is intended to be easy for repository admins to use, and also for developers to extend. [Writing submodules](docs/Plugins.md) that provide data source plugins is fairly straight forward.
